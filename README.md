...
This project demonstrates how to retrieve, process, store, & visualize geolocation data using Python, SQLite, & OpenStreetMap APIs.
...
Screenshots of the terminal execution and map visualization are included in the `project screenshots/` folder & below.
